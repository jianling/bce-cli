...
Setup.fetchBase = function fetchWrapper(options) {
  var q = Q.defer();
...
Setup.runSpawnCommand = function runSpawnCommand(cmd, args) {
  var q = Q.defer();
...
Setup.addDefaultPlatforms = function addDefaultPlatforms(options) {
  var promises = [];
